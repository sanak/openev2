...
**
** $Date: 2005/04/18 16:38:34 $ $Revision: 1.1.1.1 $
** $Header: /art-cvs/proj/ev2/src/lib/tess/tess.c,v 1.1.1.1 2005/04/18 16:38:34 uid1026 Exp $
*/
...
/*ARGSUSED*/ GLAPI void APIENTRY __gl_noBeginData( GLenum type,
					     void *polygonData ) {}
/*ARGSUSED*/ GLAPI void APIENTRY __gl_noEdgeFlagData( GLboolean boundaryEdge, 
				       void *polygonData ) {}
/*ARGSUSED*/ GLAPI void APIENTRY __gl_noVertexData( void *data,
					      void *polygonData ) {}
/*ARGSUSED*/ GLAPI void APIENTRY __gl_noEndData( void *polygonData ) {}
/*ARGSUSED*/ GLAPI void APIENTRY __gl_noErrorData( GLenum errnum,
					     void *polygonData ) {}
/*ARGSUSED*/ GLAPI void APIENTRY __gl_noCombineData( GLdouble coords[3],
					       void *data[4],
					       GLfloat weight[4],
					       void **outData,
					       void *polygonData ) {}
...
GLAPI void APIENTRY
gluTessCallback( GLUtesselator *tess, GLenum which, void (APIENTRY *fn)())
{
  switch( which ) {
  case GLU_TESS_BEGIN:
  ...
  case GLU_TESS_ERROR_DATA:
	...
	&__gl_noErrorData : (void (APIENTRY *)(GLenum, void *)) fn;
    return;
